          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <div className="flex items-center space-x-2">
                <h1 className="text-xl font-bold text-slate-50 tracking-tight">XGBoost Studio</h1>
                <span className="text-xs font-mono font-bold px-2 py-0.5 rounded bg-indigo-100 text-indigo-300 border border-indigo-500/30">
                  v2.4.2
                </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div className="sm:col-span-2">
                <div className="flex justify-between text-xs font-semibold mb-1">
                  ...
                  <span className="font-mono text-indigo-600 bg-indigo-500/10 px-2 py-0.5 rounded border border-indigo-100">
              ...
              <div>
                <div className="flex justify-between text-xs font-semibold mb-1">
                  <span className="text-slate-300">Tree Depth (max_depth)</span>
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className={`card-glass rounded-2xl p-6 border-t-4 ${
            isApproved ? 'border-t-emerald-500 bg-emerald-500/10/20' : 'border-t-slate-400 bg-slate-950/80/40'
          }`}>
            <div className="flex items-center justify-between pb-4 border-b border-slate-800/50">
              <span className="text-xs font-bold uppercase tracking-wider text-slate-400">Model Decision</span>
              <span className="text-xs font-mono font-medium px-2 py-0.5 rounded bg-slate-900/60 backdrop-blur-md border border-slate-700/50 text-slate-400">
                {latency} ms
              </span>
            </div>
            ...
            <div className="py-6 text-center">
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                Model confidence: <strong className="font-mono text-slate-50 font-bold">{probYes}%</strong>
              </p>
            </div>
            ...
            <div className="space-y-2 pt-4 border-t border-slate-800/50">
              <div className="flex justify-between text-xs font-semibold">
                <span className="text-slate-400">Deposit Probability (Yes)</span>
                <span className="font-mono text-lg font-bold text-slate-50">{probYes}%</span>
              </div>
          ...
          <div className="card-glass rounded-2xl p-6">
            ...
            <div className="space-y-2 text-xs">
              <div className="flex justify-between py-1.5 border-b border-slate-800/50">
                <span className="text-slate-400">Booster Algorithm</span>
                <span className="font-mono font-semibold text-slate-200">gbtree</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-slate-800/50">
                <span className="text-slate-400">Number of Trees</span>
                <span className="font-mono font-semibold text-slate-200">120 Estimators</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-slate-800/50">
                <span className="text-slate-400">Learning Rate (eta)</span>
                <span className="font-mono font-semibold text-slate-200">0.10</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-slate-800/50">
                <span className="text-slate-400">Subsample Ratio</span>
                <span className="font-mono font-semibold text-slate-200">0.85</span>
              </div>

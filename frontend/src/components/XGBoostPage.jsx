    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <div className="flex items-center space-x-2">
                <h1 className="text-xl font-bold text-slate-900 tracking-tight">XGBoost Studio</h1>
                <span className="text-xs font-mono font-bold px-2 py-0.5 rounded bg-indigo-100 text-indigo-700 border border-indigo-200">
                  v2.4.2
                </span>
          ...
          <div className="flex items-center space-x-3">
            <div className="px-3.5 py-2 rounded-xl bg-slate-50 border border-slate-200 text-right">
              <span className="text-[10px] text-slate-400 font-semibold block uppercase tracking-wider">P95 Speed</span>
              <span className="text-lg font-bold font-mono text-indigo-600">{latency} ms</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div className="sm:col-span-2">
                <div className="flex justify-between text-xs font-semibold mb-1">
                  <span className="text-slate-700">Call Engagement Duration</span>
              ...
              <div className="sm:col-span-2">
                <div className="flex justify-between text-xs font-semibold mb-1">
                  <span className="text-slate-700">Customer Account Balance</span>
                  <span className="font-mono text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded border border-indigo-100">
              ...
              <div>
                <div className="flex justify-between text-xs font-semibold mb-1">
                  ...
                  <span className="font-mono text-indigo-600">{inputs.age} yrs</span>
                </div>
                <input 
                  type="range"
                  min="18"
              ...
              <div>
                <div className="flex justify-between text-xs font-semibold mb-1">
                  <span className="text-slate-700">Campaign Contacts</span>
                  <span className="font-mono text-indigo-600">{inputs.campaign}</span>
                </div>
                <input 
                  type="range"
                  min="1"
              ...
              <div>
                <div className="flex justify-between text-xs font-semibold mb-1">
                  <span className="text-slate-700">Tree Depth (max_depth)</span>
                  <span className="font-mono text-indigo-600">{inputs.maxDepth}</span>
                </div>
                <input 
                  type="range"
                  min="3"
        ...
        <div className="lg:col-span-5 space-y-6">
          {/* Main Decision Box */}
          <div className={`card-clean rounded-2xl p-6 border-t-4 ${
            isApproved ? 'border-t-emerald-500 bg-emerald-50/20' : 'border-t-slate-400 bg-slate-50/40'
          }`}>
            <div className="flex items-center justify-between pb-4 border-b border-slate-100">
              <span className="text-xs font-bold uppercase tracking-wider text-slate-400">Model Decision</span>
              <span className="text-xs font-mono font-medium px-2 py-0.5 rounded bg-white border border-slate-200 text-slate-600">
                {latency} ms
              </span>
            </div>
            ...
            <div className="py-6 text-center">
              <div className={`w-20 h-20 mx-auto rounded-3xl flex items-center justify-center shadow-lg mb-3 ${
                isApproved ? 'bg-emerald-600 text-white shadow-emerald-200' : 'bg-rose-600 text-white shadow-rose-200'
              }`}>
              ...
              <p className="text-xs text-slate-500 mt-0.5">
                Model confidence: <strong className="font-mono text-slate-900 font-bold">{probYes}%</strong>
              </p>
            </div>
            ...
            <div className="space-y-2 pt-4 border-t border-slate-100">
              <div className="flex justify-between text-xs font-semibold">
                <span className="text-slate-600">Deposit Probability (Yes)</span>
                <span className="font-mono text-lg font-bold text-slate-900">{probYes}%</span>
              </div>
          ...
          <div className="card-clean rounded-2xl p-6">
            ...
            <div className="space-y-2 text-xs">
              <div className="flex justify-between py-1.5 border-b border-slate-100">
                <span className="text-slate-500">Booster Algorithm</span>
                <span className="font-mono font-semibold text-slate-800">gbtree</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-slate-100">
                <span className="text-slate-500">Number of Trees</span>
                <span className="font-mono font-semibold text-slate-800">120 Estimators</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-slate-100">
                <span className="text-slate-500">Learning Rate (eta)</span>
                <span className="font-mono font-semibold text-slate-800">0.10</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-slate-100">
                <span className="text-slate-500">Subsample Ratio</span>
                <span className="font-mono font-semibold text-slate-800">0.85</span>
              </div>
              <div className="flex justify-between py-1.5">
                <span className="text-slate-500">Validation AUC-ROC</span>

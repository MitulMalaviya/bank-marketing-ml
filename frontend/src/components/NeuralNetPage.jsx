...
export default function NeuralNetPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header Banner */}
      <div className="card-clean rounded-2xl p-6 bg-gradient-to-r from-white via-purple-50/20 to-white">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center space-x-4">
            <div className="w-12 h-12 rounded-2xl bg-purple-600 text-white flex items-center justify-center shadow-md shadow-purple-100 flex-shrink-0">
              <Network className="w-6 h-6" />
            </div>
            <div>
              <div className="flex items-center space-x-2">
                <h1 className="text-xl font-bold text-slate-900 tracking-tight">Neural Network Deep Lab</h1>
                <span className="text-xs font-mono font-bold px-2 py-0.5 rounded bg-purple-100 text-purple-700 border border-purple-200">
                  v3.1.0
                </span>
      ...
      <div className="card-clean rounded-2xl p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-5 gap-3 text-center">
          <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200">
            ...
            <span className="text-base font-bold font-mono text-slate-800 mt-1 block">16 Features</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div className="sm:col-span-2">
                <div className="flex justify-between text-xs font-semibold mb-1">
                  ...
                  <span className="font-mono text-purple-600 bg-purple-50 px-2 py-0.5 rounded border border-purple-100">
                ...
                <input 
                  ...
                  className="w-full h-2 bg-slate-100 rounded-lg cursor-pointer accent-purple-600"
                />
              </div>
              ...
              <div className="sm:col-span-2">
                <div className="flex justify-between text-xs font-semibold mb-1">
                  <span className="text-slate-700">Account Balance</span>
                  <span className="font-mono text-purple-600 bg-purple-50 px-2 py-0.5 rounded border border-purple-100">
              ...
              {/* Activation Function */}
              <div>
                <label className="text-xs font-semibold text-slate-700 block mb-1">Activation Function</label>
                <select
              ...
              <div>
                <div className="flex justify-between text-xs font-semibold mb-1">
                  <span className="text-slate-700">Dropout Rate</span>
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="card-clean rounded-2xl p-6 border-t-4 border-t-purple-600">
            <div className="flex items-center justify-between pb-4 border-b border-slate-100">
              <span className="text-xs font-bold uppercase tracking-wider text-slate-400">Softmax Output</span>
              <span className="text-xs font-mono font-medium px-2 py-0.5 rounded bg-slate-50 border border-slate-200 text-slate-600">
                {latency} ms
              </span>
            </div>
            ...
            <div className="py-6 text-center">
              ...
              <h3 className={`text-4xl font-black tracking-tight ${
                isApproved ? 'text-purple-700' : 'text-rose-700'
              }`}>
                {isApproved ? 'YES ✅' : 'NO ❌'}
              </h3>
              ...
              <p className="text-xs text-slate-500 mt-0.5">
                Neural network confidence: <strong className="font-mono text-slate-900 font-bold">{probYes}%</strong>
              </p>
            </div>
            ...
            <div className="space-y-2 pt-4 border-t border-slate-100">
              <div className="flex justify-between text-xs font-semibold">
                <span className="text-purple-700">Class 1 Probability (Yes)</span>
                <span className="font-mono text-slate-900 font-bold">{probYes}%</span>
              </div>
              ...
              <div className="flex justify-between text-xs font-semibold mt-2">
                <span className="text-slate-500">Class 0 Probability (No)</span>
                <span className="font-mono text-slate-700">{probNo}%</span>
              </div>
            </div>
          </div>
          ...
          <div className="card-clean rounded-2xl p-6">
            ...
            <div className="space-y-2 text-xs">
              <div className="flex justify-between py-1.5 border-b border-slate-100">
                ...
                <span className="font-mono font-semibold text-slate-800">12,834 Weights</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-slate-100">
                <span className="text-slate-500">Optimizer</span>
                <span className="font-mono font-semibold text-slate-800">Adam (lr=0.001)</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-slate-100">
                <span className="text-slate-500">Loss Function</span>
                <span className="font-mono font-semibold text-slate-800">Binary Cross-Entropy</span>
              </div>

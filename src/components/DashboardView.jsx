  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-50 tracking-tight">System Overview</h1>
        ...
        <div className="flex items-center space-x-3">
          <button
            ...
            className="flex items-center space-x-2 px-3.5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-xs font-semibold shadow-lg shadow-black/10 shadow-indigo-200 transition"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="card-glass rounded-2xl p-5 card-glass-hover">
          <div className="flex items-center justify-between text-slate-400 text-xs mb-2">
            <span className="font-semibold text-slate-400 uppercase tracking-wider text-[11px]">Total Requests</span>
            <div className="w-8 h-8 rounded-lg bg-indigo-500/10 text-indigo-600 flex items-center justify-center">
              <Activity className="w-4 h-4" />
            </div>
          </div>
          <div className="text-2xl font-bold text-slate-50">1,284,930</div>
        ...
        <div className="card-glass rounded-2xl p-5 card-glass-hover">
          <div className="flex items-center justify-between text-slate-400 text-xs mb-2">
            <span className="font-semibold text-slate-400 uppercase tracking-wider text-[11px]">Average Latency</span>
            <div className="w-8 h-8 rounded-lg bg-emerald-500/10 text-emerald-600 flex items-center justify-center">
              <Zap className="w-4 h-4" />
            </div>
          </div>
          <div className="text-2xl font-bold text-slate-50">24.6 ms</div>
          <div className="flex items-center space-x-1.5 mt-2">
            <span className="inline-flex items-center text-xs font-semibold text-emerald-600 bg-emerald-500/10 px-1.5 py-0.5 rounded border border-emerald-500/30">
              <ArrowDownRight className="w-3 h-3 mr-0.5" /> -3.2 ms
            </span>
            <span className="text-[11px] text-slate-400">P95: 38.4 ms</span>
          </div>
        </div>
        ...
        <div className="card-glass rounded-2xl p-5 card-glass-hover">
          <div className="flex items-center justify-between text-slate-400 text-xs mb-2">
            <span className="font-semibold text-slate-400 uppercase tracking-wider text-[11px]">Model Accuracy</span>
            <div className="w-8 h-8 rounded-lg bg-teal-500/10 text-teal-600 flex items-center justify-center">
              <Award className="w-4 h-4" />
            </div>
          </div>
          <div className="text-2xl font-bold text-slate-50">94.2%</div>
          <div className="flex items-center space-x-1.5 mt-2">
            <span className="inline-flex items-center text-xs font-semibold text-emerald-600 bg-emerald-500/10 px-1.5 py-0.5 rounded border border-emerald-500/30">
              <ArrowUpRight className="w-3 h-3 mr-0.5" /> +0.8%
            </span>
            <span className="text-[11px] text-slate-400">Benchmark: 90.2%</span>
          </div>
        </div>
        ...
        <div className="card-glass rounded-2xl p-5 card-glass-hover">
          <div className="flex items-center justify-between text-slate-400 text-xs mb-2">
            <span className="font-semibold text-slate-400 uppercase tracking-wider text-[11px]">Active Models</span>
            <div className="w-8 h-8 rounded-lg bg-indigo-500/10 text-indigo-600 flex items-center justify-center">
              <Cpu className="w-4 h-4" />
            </div>
          </div>
          <div className="text-2xl font-bold text-slate-50">4 Online</div>
          <div className="flex items-center space-x-1.5 mt-2">
      ...
      <div className="card-glass rounded-2xl p-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            <h2 className="text-base font-bold text-slate-50 tracking-tight">Traffic Volume vs. Inference Latency</h2>
          ...
          {/* Timeframe selector */}
          <div className="inline-flex p-1 rounded-xl bg-slate-800/80 border border-slate-700/50 text-xs font-semibold">
            {['24h', '7d', '30d'].map((t) => (
              <button
                key={t}
                ...
                className={`px-3 py-1 rounded-lg transition ${
                  timeframe === t 
                    ? 'bg-slate-900/60 backdrop-blur-md text-indigo-600 shadow-lg shadow-black/10' 
      ...
      <div className="card-glass rounded-2xl p-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-5">
          <div>
            <h2 className="text-base font-bold text-slate-50 tracking-tight">Recent Inference Logs</h2>
            <p className="text-xs text-slate-400 mt-0.5">
          ...
          <div className="flex items-center space-x-2.5">
            <div className="relative">
              ...
              <input
                ...
                className="bg-slate-950/80 border border-slate-700/50 rounded-xl pl-8 pr-3 py-1.5 text-xs text-slate-200 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:bg-slate-900/60 backdrop-blur-md w-48 transition"
              />
            </div>
            ...
            <select
              ...
              className="bg-slate-950/80 border border-slate-700/50 rounded-xl px-2.5 py-1.5 text-xs text-slate-300 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:bg-slate-900/60 backdrop-blur-md transition"
            >
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead className="bg-slate-950/80 text-slate-400 font-semibold uppercase tracking-wider text-[10px] border-b border-slate-700/50">
              <tr>
            ...
            <tbody className="divide-y divide-slate-100 text-slate-300">
              {filteredLogs.map((log) => (
                <tr key={log.id} className="hover:bg-slate-950/80/80 transition">
                  <td className="py-3 px-3.5 font-mono text-slate-400 font-medium">{log.id}</td>
                  <td className="py-3 px-3.5 text-slate-400 whitespace-nowrap">{log.timestamp}</td>
                  <td className="py-3 px-3.5">
                    <span className="font-semibold text-slate-50 bg-slate-800/80 px-2 py-0.5 rounded text-[11px] border border-slate-700/50">
                      {log.model}
                    </span>
                  </td>
                  <td className="py-3 px-3.5 font-mono text-slate-400 text-[11px] truncate max-w-xs" title={log.inputSummary}>
                    {log.inputSummary}
                  </td>
                  ...
                  <td className="py-3 px-3.5 font-bold font-mono text-slate-200">
                    {log.confidence}%
                  </td>

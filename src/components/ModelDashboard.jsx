...
export default function ModelDashboard() {
  ...
  return (
    <div className="space-y-6">
      {/* Header Banner */}
      <div className="glass-panel rounded-2xl p-6 border border-zinc-800 bg-gradient-to-r from-zinc-950 via-zinc-900 to-emerald-950/40">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-3">
            <div className="px-4 py-2 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-right">
              <span className="text-[11px] font-semibold text-zinc-400 block">Overall Test Accuracy</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="glass-panel p-5 rounded-2xl border border-zinc-800">
          ...
          <div className="text-3xl font-extrabold text-zinc-50">90.16%</div>
        ...
        <div className="glass-panel p-5 rounded-2xl border border-zinc-800">
          ...
          <div className="text-3xl font-extrabold text-emerald-300">65.0%</div>
          <span className="text-[11px] text-zinc-400 mt-1 block">Reliability of positive calls</span>
        </div>
        ...
        <div className="glass-panel p-5 rounded-2xl border border-zinc-800">
          ...
          <span className="text-[11px] text-zinc-400 mt-1 block">Coverage of total subscribers</span>
        </div>
        ...
        <div className="glass-panel p-5 rounded-2xl border border-zinc-800">
          ...
          <span className="text-[11px] text-zinc-400 mt-1 block">Harmonic mean balance</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 glass-panel rounded-2xl p-6 border border-zinc-800 flex flex-col justify-between">
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 text-center">
              ...
              <div className="p-4 rounded-xl bg-emerald-950/20 border border-emerald-500/30">
                ...
                <span className="text-2xl font-extrabold text-zinc-50 mt-1 block">7,760</span>
                <span className="text-[10px] text-zinc-400 mt-0.5 block">Predicted No, Actual No</span>
              </div>
              ...
              <div className="p-4 rounded-xl bg-rose-950/20 border border-rose-500/30">
                ...
                <span className="text-[10px] text-zinc-400 mt-0.5 block">Predicted Yes, Actual No</span>
              </div>
              ...
              <div className="p-4 rounded-xl bg-amber-950/20 border border-amber-500/30">
                ...
                <span className="text-[10px] text-zinc-400 mt-0.5 block">Predicted No, Actual Yes</span>
              </div>
              ...
              <div className="p-4 rounded-xl bg-emerald-950/20 border border-emerald-500/30">
                ...
                <span className="text-2xl font-extrabold text-emerald-400 mt-1 block">370</span>
                <span className="text-[10px] text-zinc-400 mt-0.5 block">Predicted Yes, Actual Yes</span>
              </div>
            </div>
          </div>

          <div className="mt-5 pt-4 border-t border-zinc-800 text-[11px] text-zinc-400 flex justify-between">
            <span>Specificity: <strong className="text-zinc-200">97.2%</strong></span>
            <span>Sensitivity: <strong className="text-zinc-200">35.0%</strong></span>
          </div>
        </div>

        {/* Actual vs Predicted Visual Chart (7 cols) */}
        <div className="lg:col-span-7 glass-panel rounded-2xl p-6 border border-zinc-800">
      ...
      <div className="glass-panel rounded-2xl p-6 border border-zinc-800">
        <h3 className="text-sm font-bold uppercase tracking-wider text-zinc-200 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
          <div className="bg-zinc-900/60 p-4 rounded-xl border border-zinc-800">
            <span className="text-zinc-400 block mb-1">Algorithm</span>
            <span className="font-semibold text-zinc-200 text-sm">Logistic Regression</span>
            <p className="text-zinc-400 text-[11px] mt-1">L-BFGS optimization with L2 regularization penalty</p>
          </div>
          <div className="bg-zinc-900/60 p-4 rounded-xl border border-zinc-800">
            <span className="text-zinc-400 block mb-1">Feature Engineering</span>
            <span className="font-semibold text-zinc-200 text-sm">StandardScaler + One-Hot</span>
            <p className="text-zinc-400 text-[11px] mt-1">Numeric standard normalization, categorical dummy variables with drop_first=True</p>
          </div>
          <div className="bg-zinc-900/60 p-4 rounded-xl border border-zinc-800">
            <span className="text-zinc-400 block mb-1">Validation Split</span>
            <span className="font-semibold text-zinc-200 text-sm">80/20 Stratified</span>
            <p className="text-zinc-400 text-[11px] mt-1">Random state 42 preserving target label distribution</p>
          </div>
        </div>
      </div>
    </div>

    ...
    <div className="space-y-6">
      ...
      <div className="card-glass rounded-2xl p-6 bg-gradient-to-r from-zinc-900/40 via-emerald-900/10 to-zinc-900/40">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center space-x-4">
            <div className="w-12 h-12 rounded-2xl bg-purple-600 text-zinc-50 flex items-center justify-center shadow-xl shadow-black/20 shadow-purple-100 flex-shrink-0">
              <Network className="w-6 h-6" />
            </div>
            <div>
              <div className="flex items-center space-x-2">
                <h1 className="text-xl font-bold text-zinc-50 tracking-tight">Neural Network Deep Lab</h1>
          ...
          <div className="flex items-center space-x-3">
            <div className="px-3.5 py-2 rounded-xl bg-zinc-950/80 border border-zinc-700/50 text-right">
              <span className="text-[10px] text-zinc-400 font-semibold block uppercase tracking-wider">Test Accuracy</span>
      ...
      <div className="card-glass rounded-2xl p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-5 gap-3 text-center">
          <div className="p-3.5 rounded-xl bg-zinc-950/80 border border-zinc-700/50">
            <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider block">Layer 0 (Input)</span>
            <span className="text-base font-bold font-mono text-zinc-200 mt-1 block">16 Features</span>
            <span className="text-[10px] text-zinc-400 block mt-0.5">Normalized Batch</span>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div className="sm:col-span-2">
                ...
                <input 
                  ...
                  className="w-full h-2 bg-zinc-800/80 rounded-lg cursor-pointer accent-purple-600"
                />
              </div>
              ...
              <div className="sm:col-span-2">
                <div className="flex justify-between text-xs font-semibold mb-1">
                  <span className="text-zinc-300">Account Balance</span>
                  <span className="font-mono text-purple-600 bg-purple-500/10 px-2 py-0.5 rounded border border-purple-100">
              ...
              {/* Activation Function */}
              <div>
                <label className="text-xs font-semibold text-zinc-300 block mb-1">Activation Function</label>
                <select
              ...
              <div>
                <div className="flex justify-between text-xs font-semibold mb-1">
                  <span className="text-zinc-300">Dropout Rate</span>
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="card-glass rounded-2xl p-6 border-t-4 border-t-purple-600">
            <div className="flex items-center justify-between pb-4 border-b border-zinc-800/50">
              <span className="text-xs font-bold uppercase tracking-wider text-zinc-400">Softmax Output</span>
            ...
            <div className="py-6 text-center">
              <div className={`w-20 h-20 mx-auto rounded-3xl flex items-center justify-center shadow-lg mb-3 ${
                isApproved ? 'bg-purple-600 text-zinc-50 shadow-purple-200' : 'bg-rose-600 text-zinc-50 shadow-rose-200'
              }`}>
              ...
              <p className="text-xs text-zinc-400 mt-0.5">
                Neural network confidence: <strong className="font-mono text-zinc-50 font-bold">{probYes}%</strong>
              </p>
            </div>
            ...
            <div className="space-y-2 pt-4 border-t border-zinc-800/50">
              <div className="flex justify-between text-xs font-semibold">
                ...
                <span className="font-mono text-zinc-50 font-bold">{probYes}%</span>
              </div>
              ...
              <div className="flex justify-between text-xs font-semibold mt-2">
                <span className="text-zinc-400">Class 0 Probability (No)</span>
                <span className="font-mono text-zinc-300">{probNo}%</span>
              </div>
            </div>
          </div>
          ...
          <div className="card-glass rounded-2xl p-6">
            ...
            <div className="space-y-2 text-xs">
              <div className="flex justify-between py-1.5 border-b border-zinc-800/50">
                ...
                <span className="font-mono font-semibold text-zinc-200">12,834 Weights</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-zinc-800/50">
                <span className="text-zinc-400">Optimizer</span>
                <span className="font-mono font-semibold text-zinc-200">Adam (lr=0.001)</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-zinc-800/50">
                <span className="text-zinc-400">Loss Function</span>
                <span className="font-mono font-semibold text-zinc-200">Binary Cross-Entropy</span>
              </div>
              <div className="flex justify-between py-1.5">
                <span className="text-zinc-400">Device Target</span>
                <span className="font-mono font-bold text-emerald-600">CUDA / CPU Auto</span>
              </div>
            </div>
          </div>
        </div>
